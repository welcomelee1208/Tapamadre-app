                ...
                >
                    ...
                    <div className="offcanvas-body">
                        ...
                        <div className="card px-1 py-3 card-body flex-row border-0">
                            <div className="me-3">
                                <img src="assets/img/menu/dessert1.jpg" alt="" className="width-70 rounded-3 shadow" />
                            </div>
                        ...
                        <div className="card px-1 py-3 card-body flex-row border-0">
                            <div className="me-3">
                                <img src="assets/img/menu/dessert2.jpg" alt="" className="width-70 rounded-3 shadow" />
                            </div>
                            <div className="flex-grow-1">
                    ...
                    <section className="position-relative border-top">
                        <div className="container pt-8 pb-9 pt-lg-9 position-relative z-index-1">
                            <div className="row justify-content-between">
                                <div className="col-md-6 col-xl-5 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="50">
                                    <h1 className="display-4 mb-3">How may we Serve you?</h1>
                                    <p className="pe-md-5 pe-lg-8 mb-0">
                                        Feel free to request reservation for one table or entire space for a large party
                                        or event
                                    </p>
                                </div>
